...
if __name__ == '__main__':
    ...
    # print(scj.compute_weighted_RTE_pi(Q, D_idx, W, w_max, pi, N_eta))
    print(scj.loss_weighted_MHT_pi(Q, A, W, pi, alpha))
    print(scj.comp_weighted_MHT_pi_grad(Q, A, W, pi, alpha))