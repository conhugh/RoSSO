...
d_test_spec= ts.TestSpec(test_spec_filepath=os.getcwd() + "/TestSpecs/tau_study_gridgraphs_v1.json")
...
d_test_spec.save_test_spec("tau_study_gridgraphs_v1", os.getcwd() + "/TestSpecs")
