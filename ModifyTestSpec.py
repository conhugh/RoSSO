...
test_spec_name = "Random_Tree_Graph_Test_Specification"
...
for i in range(1, 22, 3):
    ...
    test_graph_names["test" + str(i + 1)] = graph_name
    test_graph_codes["test" + str(i + 1)] = graph_code
    test_taus["test" + str(i + 1)] = graph_diam(graph) + 2
    test_graph_names["test" + str(i + 2)] = graph_name
    test_graph_codes["test" + str(i + 2)] = graph_code
    test_taus["test" + str(i + 2)] = graph_diam(graph) + 3
...
d_test_spec= ts.TestSpec(test_spec_filepath=os.getcwd() + "/TestSpecs/init_study_randtree_graph.json")
d_test_spec.test_spec_name = test_spec_name
d_test_spec.num_tests = 24
d_test_spec.graph_names = test_graph_names
d_test_spec.taus = test_taus
d_test_spec.graph_codes = test_graph_codes
d_test_spec.save_test_spec("init_study_randtree_graph", os.getcwd() + "/TestSpecs")
