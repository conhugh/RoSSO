...
for i in range(1, 5):
    graph, graph_name = gen_grid_G(3, i)
...
d_test_spec= ts.TestSpec(test_spec_filepath=os.getcwd() + "/TestSpecs/grid_graph_aspect_ratio_study.json")
...
d_test_spec.save_test_spec("grid_graph_aspect_ratio_study", os.getcwd() + "/TestSpecs")
